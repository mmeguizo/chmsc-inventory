...
export class EmployeeProfileComponent implements OnInit {
	...
	socketInstance;
	allPosition: any;
	constructor(public sgs: SharedGlobalService, public route: ActivatedRoute, public formBuilder: FormBuilder, public ngbModal: NgbModal) {
		this.createForm();
